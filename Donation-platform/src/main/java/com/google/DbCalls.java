...
public final class DbCalls {
  ...
  public void addCharity(String name, String link, Collection<Key> categories, String description)
      throws Exception {
  ...
  public void addUser(
      String userName,
      String email,
      Collection<Key> userInterests,
      Collection<Key> charitiesDonatedTo)
      throws Exception {
