...
public final class DbCalls
{
    ...
    public void addCharity(String name, String link, String imgsrc, Collection<Tag>  categories, String description) throws Exception
    {
    ...
    public void addUser(String userId, String userName, String email,
                        Collection<Tag> userInterests, Collection<Charity>  charitiesDonatedTo) throws Exception
    {
