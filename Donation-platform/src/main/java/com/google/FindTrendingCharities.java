...
public final class FindTrendingCharities {
  ...
  private Collection<Charity> getAllHardCodedCharities() {
    Collection<Charity> allCharities =
        new ArrayList<Charity>(Arrays.asList(HardCodedCharitiesAndTags.charities));
    return allCharities;
  }
  ...
  private double calcCharityTrendingScore(Charity charity) {
    ...
    double charityTrendingScore =
        charityTagsWeight * charityTagsScore + avgReviewWeight * avgReview;
