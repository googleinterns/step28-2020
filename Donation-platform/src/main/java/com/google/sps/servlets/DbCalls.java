...
public final class DbCalls {
    ...
    for (Entity entity : results.asIterable())
        {
            ...
            List<Integer> categories = (List<Integer>) entity.getProperty("categories");
    ...
    for (Entity entity : results.asIterable())
        {
            ...
            List<Integer>  userInterests = (List<Integer> ) entity.getProperty("userInterests");
            List<Integer>  charitiesDonatedTo = (List<Integer> ) entity.getProperty("charitiesDonatedTo");
  ...
  public void addCharity(String name, String link,
              Collection<Integer>  categories, String description){
    initializeDatastore();
  ...
  public void addTag(String name, Integer trendingScore){
    initializeDatastore();
